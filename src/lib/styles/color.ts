...
export const colorStyleParts: Record<ColorStyle, Record<ColorStyleType, string>> = {
    red: {
        ...
        ghost: "text-red-500 hover:text-red-600 hover:bg-red-500/10"
    },
    yellow: {
        ...
        ghost: "text-yellow-500 hover:text-yellow-600 hover:bg-yellow-500/10"
    },
    lightgreen: {
        ...
        ghost: "text-green-500 hover:text-green-600 hover:bg-green-500/10"
    },
    blue: {
        ...
        ghost: "text-blue-500 hover:text-blue-600 hover:bg-blue-500/10"
    },
    pink: {
        ...
        ghost: "text-pink-500 hover:text-pink-600 hover:bg-pink-500/10"
    },
    purple: {
        ...
        ghost: "text-purple-500 hover:text-purple-600 hover:bg-purple-500/10"
    },
    gray: {
        ...
        ghost: "text-gray-500 hover:text-gray-600 hover:bg-gray-500/10"
    },
    sub: {
        ...
        ghost: "text-sub-background hover:text-sub-background-hover hover:bg-sub-background/10"
    },
    none: {
        full: "",
        light: "",
